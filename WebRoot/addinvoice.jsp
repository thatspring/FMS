...
<<<<<<< HEAD
     						<td width="200px" colspan="2" height="135px">
     							<input type="text" name="invoice.invoiceProject" style="width:200px;height:135px">
     						</td>
     						<td width="200px" colspan="2" height="135px"></td>
     						<td width="200px" colspan="2" height="135px"></td>
     						<td width="200px" colspan="2" height="135px">
     							<input type="text" name="invoice.invoiceMoney" style="width:200px;height:135px">
=======
...
<<<<<<< HEAD
     							<input type="text" name="invoice.invoiceCmoney" style="width:750px;height:30px">
=======
...
<<<<<<< HEAD
     							<input type="text" name="invoice.invoiceType"/>
=======
