...
<<<<<<< HEAD
    	...
    	<div id="label"><input value="所在部门" disabled="disabled"></div>
    	<div id="s_con"><s:property value="ruser.userDepartment"/></div>
    	<div id="label"><input value="现任职务" disabled="disabled"></div>
    	<div id="s_con"><s:property value="ruser.userPost"/></div>
    	<div id="label"><input value="办公电话" disabled="disabled"></div>
